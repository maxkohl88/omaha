...
($scope, Route) ->
  ...
  wr1Path = drawPath wr1Coordinates, offense, field
  wr2Path = drawPath wr2Coordinates, offense, field
  wr3Path = drawPath wr3Coordinates, offense, field
  tePath = drawPath teCoordinates, offense, field
  rbPath = drawPath rbCoordinates, offense, field
  qbPath = drawPath qbCoordinates, offense, field
  ltPath = drawPath ltCoordinates, offense, field
  lgPath = drawPath lgCoordinates, offense, field
  cPath = drawPath cCoordinates, offense, field
  rgPath = drawPath rgCoordinates, offense, field
  rtPath = drawPath rtCoordinates, offense, field

  lcbPath = drawPath lcbCoordinates, defense, field
  rcbPath = drawPath rcbCoordinates, defense, field
  leftSafetyPath = drawPath leftSafetyCoordinates, defense, field
  rightSafetyPath = drawPath rightSafetyCoordinates, defense, field
  leftLbPath = drawPath leftLbCoordinates, defense, field
  rightLbPath = drawPath rightLbCoordinates, defense, field
  nickelCornerPath = drawPath nickelCornerCoordinates, defense, field
  leftDEPath = drawPath leftDECoordinates, defense, field
  dtPath = drawPath dtCoordinates, defense, field
  ntPath = drawPath ntCoordinates, defense, field
  rightDEPath = drawPath rightDECoordinates, defense, field
